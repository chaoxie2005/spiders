...
def spider(page):
    jspath = r'D:\爬虫项目\爬虫\js逆向\41-中国观鸟记录中心\sign.js'
    data = {"limit":"20","page":page}
    params = ex_js(jspath, 'get_sign', data)
    sign = params[0]
    requestId = params[1]
    timestamp = params[2]
    post_data = params[3]
    ...
    response = requests.post('https://api.birdreport.cn/front/record/activity/search', headers=headers, data=data, timeout=4)
